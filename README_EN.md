...
| --- | --- | --- |
| [OpenAI Codex: Use cases](https://learn.chatgpt.com/use-cases) | Package repeatable workflows as reusable skills | `SKILL.md` defines the stable workflow; a Python helper handles deterministic operations |
